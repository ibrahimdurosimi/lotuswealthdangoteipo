...
const steps = [
  ...
  },
  {
    ...
    description: 'Read the prospectus to thoroughly understand the investment opportunity.',
    icon: FileText,
  ...
  },
  {
    ...
    number: '03',
    title: 'Apply',
    description: "Select how many shares you would like to apply for and submit your application securely through LOTUS Wealth.",
    icon: CheckCircle2,
